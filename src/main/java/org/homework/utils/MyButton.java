...
public class MyButton extends JButton {
    ...
    public static Color sky2 = new Color(211, 218, 233);
    /*光标进入按钮判断*/
    ...
    public static void main(String args[]) {
        ...
        MyButton but = new MyButton("圆角JButton",1);
        frm.setLayout(null);
    ...
    public void addMyMouse(MouseListener listener) {
    ...
    protected void paintComponent(Graphics g) {
        ...
        int with = getWidth() ;
        float tran = 1F;
        if (!hover && !isClick) {/* 鼠标离开/进入时的透明度改变量 */
            tran = 0.0F;
        }
